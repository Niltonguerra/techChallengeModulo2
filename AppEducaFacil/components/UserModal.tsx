          ...
          <View style={styles.container} onStartShouldSetResponder={() => true}>
            ...
            {user.permission === 'admin' && (
              <>
                ...
                >
                  <Text style={styles.optionText}>Controle de Postagens</Text>
                </TouchableOpacity>
                ...
                >
                  <Text style={styles.optionText}>Controle de Alunos</Text>
                </TouchableOpacity>
                ...
                >
                  <Text style={styles.optionText}>Controle de Professores</Text>
                </TouchableOpacity>
              </>
            )}
